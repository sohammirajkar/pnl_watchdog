...
def run_profit_demonstration():
    ...
    # Simulation Loop (Live Data) - Run only 3 iterations for demo
    for i in range(3):  # Reduced from 10 to 3 for quicker demo
        symbol = random.choice(SYMBOLS)
        print(f"[{i+1}/3] Analyzing Opportunity: {symbol}...")
